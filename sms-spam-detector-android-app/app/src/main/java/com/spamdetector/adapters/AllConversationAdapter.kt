...
import com.spamdetector.SMS
import com.spamdetector.adapters.AllConversationAdapter.MyHolder
import com.spamdetector.utils.ColorGeneratorModified
import com.spamdetector.utils.Helpers
...
class AllConversationAdapter(private val context: Context, private val data: ArrayList<SMS>?)
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        val activity:Activity = this.context as Activity
        Helpers.makePostRequest(sms.msg,position,holder.itemView.findViewById<ImageView>(R.id.redDot),activity)
